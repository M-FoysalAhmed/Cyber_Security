...
function encrypt() {
    ...
    // for row transposition cipher 
      ...
      // Create a matrix using the rectangle characters
      var matrix = [];
      ...
      // Transpose the matrix according to the serial of the key
...
// for decryption 
  function decrypt() {
    ...
    // for decryption railfeence cipher
    if (algorithm == "railfence"){
